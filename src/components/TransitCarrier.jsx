...
export default function TransitCarrier({
  ...
  const isDimmed = Boolean(isNearNode) && !isHovered;
    ...
    <div
      ...
      >
        <div className="relative flex flex-col items-center">
          ...
          {isHovered && (
            <div className="absolute bottom-full mb-3 left-1/2 -translate-x-1/2 w-64 bg-[#090f1d] border-2 border-cyan-400 p-3 shadow-2xl z-50 text-left pointer-events-none font-mono opacity-100 filter-none">
              ...
              {Array.isArray(shipment.items) && shipment.items.length > 0 && (
                <div className="border-t border-slate-800 pt-1.5 text-[10px] space-y-0.5">
                  <div className="text-slate-400 mb-0.5 font-bold">{t('loadedItemsList', lang)}:</div>
