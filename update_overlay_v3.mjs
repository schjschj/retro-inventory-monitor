  ...
  return (
    <>
      ...
      <div 
        style={{
          position: 'absolute',
          left: \`\${(KEY_NODES.INCHEON.x / 1440) * 100}%\`,
          top: \`\${(KEY_NODES.INCHEON.y / 700) * 100}%\`,
      ...
      <div
        style={{
          position: 'absolute',
          left: \`\${(KEY_NODES.WEST_COAST_PORT.x / 1440) * 100}%\`,
          top: \`\${(KEY_NODES.WEST_COAST_PORT.y / 700) * 100}%\`,
          transform: 'translate(-50%, -50%)',
          zIndex: 22
        }}
      >
      ...
      <div
        style={{
          position: 'absolute',
          left: \`\${(KEY_NODES.MIDWEST_AIRPORT.x / 1440) * 100}%\`,
          top: \`\${(KEY_NODES.MIDWEST_AIRPORT.y / 700) * 100}%\`,
          transform: 'translate(-50%, -50%)',
          zIndex: 18
        }}
      >
      ...
      {/* 4. KOKOMO US FACILITY NODE (Indiana) */}
      <div 
        style={{
          position: 'absolute',
          left: \`\${(KEY_NODES.KOKOMO.x / 1440) * 100}%\`,
          top: \`\${(KEY_NODES.KOKOMO.y / 700) * 100}%\`,
          transform: 'translate(-50%, -50%)',
      ...
      >
        <div className="relative flex flex-col items-center cursor-pointer">
          ...
          <div className="text-[8.5px] font-mono text-amber-300 font-bold mt-0.5">
            [호버 시 세부 분류]
          </div>
      ...
      <div 
        style={{
          position: 'absolute',
          left: \`\${(KEY_NODES.SPE.x / 1440) * 100}%\`,
          top: \`\${(KEY_NODES.SPE.y / 700) * 100}%\`,
          transform: 'translate(-50%, -50%)',
...
console.log('NodeOverlay.jsx updated with exact coordinates and no SPE truck.');
